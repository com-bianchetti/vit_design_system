...
///
/// The [VitAvatar] widget supports a wide range of customization options, including:
...
/// )
/// ```
class VitAvatar extends StatefulWidget {
  ...
  @override
  State<VitAvatar> createState() => _VitAvatarState();
}

class _VitAvatarState extends State<VitAvatar> {
  late IconData? icon;
  ...
  Widget build(BuildContext context) {
    ...
    if (effectiveLoading) {
      final skeletonAvatar = VitSkeletonShimmer(
        child: CircleAvatar(

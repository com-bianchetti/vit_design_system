...
///
/// [BitAvatarPreview] is a convenience wrapper around [BitAvatar] for displaying a larger, non-interactive avatar preview.
/// It is ideal for profile screens or anywhere a prominent avatar display is needed. It supports the same customization options as [BitAvatar],
...
/// )
/// ```
class BitAvatarPreview extends StatelessWidget {
  ...
  /// Creates a [BitAvatarPreview] widget.
  ///
  /// See class documentation for details on each parameter.
  const BitAvatarPreview({
    super.key,
    this.child,

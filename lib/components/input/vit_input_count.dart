...
///
/// The [VitInputCount] provides an input field that only accepts digits
...
class VitInputCount extends StatefulWidget {
  ...
  @override
  State<VitInputCount> createState() => _VitInputCountState();
}

class _VitInputCountState extends State<VitInputCount> {
  ...
  @override
  void didUpdateWidget(VitInputCount oldWidget) {

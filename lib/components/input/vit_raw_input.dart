...
///
/// The [VitRawInput] is a minimalist text input component that removes
...
class VitRawInput extends StatefulWidget {
  ...
  @override
  State<VitRawInput> createState() => _VitRawInputState();
}

class _VitRawInputState extends State<VitRawInput> {

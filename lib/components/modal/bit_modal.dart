...
///
/// [BitModal] provides a flexible and responsive container for displaying modal content that adapts to different screen sizes.
...
class BitModal extends StatefulWidget {
  ...
  ///
  /// Automatically set by [BitModal.show] based on screen width. When true,
  ...
  /// Creates a [BitModal] with configurable layout, content, and behavior options.
  ///
  ...
  ///
  /// For most use cases, prefer using [BitModal.show] to display the modal
  ...
  @override
  State<BitModal> createState() => _BitModalState();
...
class _BitModalState extends State<BitModal> {

...
class VitSheet extends StatefulWidget {
  ...
  ///
  /// Automatically set by [VitSheet.show] based on screen width. When true,
  ...
  /// Creates a [VitSheet] with configurable layout, content, and behavior options.
  ///
  ...
  ///
  /// For most use cases, prefer using [VitSheet.show] to display the sheet modally
  ...
  @override
  State<VitSheet> createState() => _VitSheetState();
...
class _VitSheetState extends State<VitSheet> {

...
///
/// The [VitSkeletonUtils] class contains static methods that generate placeholder
...
///
/// ```dart
/// final mockText = VitSkeletonUtils.mockString(length: 15);
/// ```
///
/// ### Generate Mock Paragraph
///
/// ```dart
/// final mockParagraph = VitSkeletonUtils.mockParagraph(
///   lines: 3,
///   charsPerLine: 40,
/// );
/// ```
...
///
/// ```dart
/// final mockIcon = VitSkeletonUtils.mockIcon();
/// Icon(mockIcon)
/// ```
class VitSkeletonUtils {
  ...
  /// Example:
  /// ```dart
  /// VitSkeletonUtils.mockString(length: 5)
  /// ```
  ...
  /// Example:
  /// ```dart
  /// VitSkeletonUtils.mockParagraph(
  ///   lines: 2,
  ///   charsPerLine: 50,
  /// )
  /// ```
  ...
  /// Example:
  /// ```dart
  /// Icon(VitSkeletonUtils.mockIcon())
  /// ```
  ...
  /// Example:
  /// ```dart
  /// VitSkeletonUtils.mockEmail(length: 25)
  /// ```
  ...
  /// Example:
  /// ```dart
  /// VitSkeletonUtils.mockNumber(length: 3)
  /// ```

...
///
/// The [BitSkeletonShimmer] wraps a widget and applies an animated shimmer
...
class BitSkeletonShimmer extends StatefulWidget {
  ...
  @override
  State<BitSkeletonShimmer> createState() => _BitSkeletonShimmerState();
}

class _BitSkeletonShimmerState extends State<BitSkeletonShimmer>
  ...
  @override
  void didUpdateWidget(BitSkeletonShimmer oldWidget) {

import 'package:bit_design_system/components/card/bit_card.dart';
...
///
/// The [BitListCard] combines the structure of [ListTile] with card styling,
...
class BitListCard extends StatelessWidget {
  ...
  ///
  /// - [BitCardVariant.standard]: Uses theme's cardColor
  /// - [BitCardVariant.elevated]: Uses theme's elevatedCardColor
  /// - [BitCardVariant.variant]: Uses theme's cardVariantColor
  /// - [BitCardVariant.elevatedVariant]: Uses theme's elevatedCardVariantColor
  ///
  /// Defaults to [BitCardVariant.standard].
  final BitCardVariant variant;
  ...
  ///
  /// When used within a [BitForm], this id can be used to identify the card.
  final String? id;

  /// Creates a [BitListCard].
  ///
  ...
  const BitListCard({
    ...
    this.variant = BitCardVariant.standard,
    this.elevation = 0,
    this.borderRadius,
    this.contentPadding,
    this.margin,
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveContentPadding = contentPadding ?? _getDefaultPadding(theme, effectiveVisualDensity);

    if (effectiveLoading) {
      return Container(
        margin: margin,
        child: BitSkeletonShimmer(
          child: Material(
            elevation: elevation,
  ...
  EdgeInsetsGeometry _getDefaultPadding(BitTheme theme, VisualDensity density) {
  ...
  Color _getVariantColor(BitTheme theme) {
    return switch (variant) {
      BitCardVariant.standard => theme.cardColor,
      BitCardVariant.elevated => theme.elevatedCardColor,
      BitCardVariant.variant => theme.cardVariantColor,
      BitCardVariant.elevatedVariant => theme.elevatedCardVariantColor,
    };
  }
}

...
///
/// The [BitCard] is a versatile container widget that can be used to group
...
class BitCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectivePadding = padding ?? _getDefaultPadding(theme, effectiveVisualDensity);
...
/// Defines the visual variant of a [BitCard].
enum BitCardVariant {

...
///
/// The [VitSelect] is a flexible select component that combines a [VitInput]
/// with a [VitPopover] to display a searchable list of options.
///
/// ## Usage
///
/// ### Basic Select
...
class VitSelect extends StatefulWidget {
  ...
  @override
  State<VitSelect> createState() => _VitSelectState();
}

class _VitSelectState extends State<VitSelect> {
  ...
  @override
  void didUpdateWidget(VitSelect oldWidget) {
  ...
  void _updateDisplayText() {
    if (widget.multiSelection) {
      _displayController.text = _selectedValues.join(
        widget.multiValueSeparator,
      );
    } else {
...
class _VitSelectPopoverContent extends StatefulWidget {
  final List<String> options;
  ...
  const _VitSelectPopoverContent({
    required this.options,
  ...
  @override
  State<_VitSelectPopoverContent> createState() =>
      _VitSelectPopoverContentState();
}

class _VitSelectPopoverContentState extends State<_VitSelectPopoverContent> {
...
class _VitSelectMultiPopoverContent extends StatefulWidget {
  final List<String> options;
  ...
  const _VitSelectMultiPopoverContent({
    required this.options,
  ...
  @override
  State<_VitSelectMultiPopoverContent> createState() =>
      _VitSelectMultiPopoverContentState();
}

class _VitSelectMultiPopoverContentState
    extends State<_VitSelectMultiPopoverContent> {
  final TextEditingController _searchController = TextEditingController();
  List<String> _filteredOptions = [];

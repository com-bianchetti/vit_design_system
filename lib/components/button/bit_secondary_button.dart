...
/// A [BitButton] wrapper widget that displays a secondary button.
class BitSecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BitButton(
      ...
      hint: hint,
      icon: icon,
      backgroundColor: context.theme.elevatedCardVariantColor,

...
/// A container widget that organizes [BitButton] widgets in a structured layout
/// adapting automatically to mobile and tablet screens.
///
/// The [BitButtonContainer] provides a convenient way to arrange buttons in a
...
class BitButtonContainer extends StatelessWidget {
  ...
  /// Creates a [BitButtonContainer].
  ///
  /// All parameters are optional and have sensible defaults.
  const BitButtonContainer({
    super.key,
    this.top = const [],
    this.middle = const [],
    this.bottom = const [],

...
///
/// The [VitButton] automatically handles press animations, sizing, and
...
class VitButton extends StatefulWidget {
  ...
  ///
  /// To explicitly prevent skeleton loading when inside a [VitLoadingScope],
  ...
  @override
  State<VitButton> createState() => _VitButtonState();
}

class _VitButtonState extends State<VitButton> {

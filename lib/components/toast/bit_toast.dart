...
///
/// [BitToast] provides a flexible and customizable way to show temporary notifications that
...
class BitToast extends StatefulWidget {
  ...
  ///
  /// Defaults to [BitToastPosition.top].
  final BitToastPosition position;
  ...
  /// Creates a [BitToast] with configurable appearance and behavior options.
  ///
  ...
  /// and behavior.
  ///
  /// For most use cases, prefer using [BitToast.show] to display the toast
  ...
  const BitToast({
    ...
    this.density,
    this.maxWidth,
    this.position = BitToastPosition.top,
  ...
  @override
  State<BitToast> createState() => _BitToastState();
  ...
  static Future<void> show(
    ...
    double? maxWidth,
    BitToastPosition position = BitToastPosition.top,
...
class _BitToastState extends State<BitToast>
  ...
  void initState() {
    ...
    final slideBegin = widget.position == BitToastPosition.top
        ? const Offset(0, -1)
        : const Offset(0, 1);
  ...
  EdgeInsets _getPadding(VisualDensity density, BitTheme theme) {
  ...
  EdgeInsets _getMargin(VisualDensity density, BitTheme theme) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isDismissible) {
      toast = Dismissible(
        key: UniqueKey(),
        direction: widget.position == BitToastPosition.top
            ? DismissDirection.up
    ...
    return Positioned(
      top: widget.position == BitToastPosition.top ? 0 : null,
      bottom: widget.position == BitToastPosition.bottom ? 0 : null,
      left: 0,
      right: 0,

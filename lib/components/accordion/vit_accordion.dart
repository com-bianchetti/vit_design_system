...
class VitAccordion extends StatefulWidget {
  /// The list of accordion items to display.
  final List<VitAccordionItem> items;
  ...
  @override
  State<VitAccordion> createState() => _VitAccordionState();
}

class _VitAccordionState extends State<VitAccordion> {
  ...
  @override
  void didUpdateWidget(VitAccordion oldWidget) {

...
///
/// The [VitSlider] can be rendered as a standalone slider or as part of a list item
...
enum VitSliderPosition {
  left,
  right,
}

class VitSlider extends StatefulWidget {
  ...
  /// of the list item. Defaults to [VitSliderPosition.right].
  /// Only applies when [title] and [showValue] are provided.
  final VitSliderPosition valuePosition;
  ...
  const VitSlider({
    ...
    this.valueFormatter,
    this.valueStyle,
    this.valuePosition = VitSliderPosition.right,
    this.visualDensity,
    this.semanticLabel,
    this.hint,
  ...
  @override
  State<VitSlider> createState() => _VitSliderState();
}

class _VitSliderState extends State<VitSlider> {
  double _value = 0.0;
  ...
  @override
  void didUpdateWidget(VitSlider oldWidget) {
          ...
          children: [
            Row(
              children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          if (widget.showValue &&
                              widget.valuePosition == VitSliderPosition.right &&
                              valueWidget != null)
                            valueWidget,
                        ],
                      ),
                ...
                if (widget.showValue &&
                    widget.valuePosition == VitSliderPosition.left &&
                    valueWidget != null) ...[
                  const SizedBox(width: 16),
                  valueWidget,
                ],

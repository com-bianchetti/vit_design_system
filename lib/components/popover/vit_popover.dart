import 'package:vit_design_system/components/sheet/vit_sheet.dart';
...
///
/// [VitPopover] is a specialized modal component that displays content in a floating container with margins on all sides, creating a dialog-like appearance. Unlike [VitSheet] which adapts between mobile bottom sheets and desktop side panels, [VitPopover] maintains a consistent centered modal presentation across all screen sizes, making it ideal for alerts, confirmations, forms, and contextual information.
///
/// Features:
...
/// - Integrates seamlessly with [VitSheet] for consistent behavior
...
class VitPopover extends StatelessWidget {
  ...
  /// [VitSheet]. Generally should not be modified. Defaults to true.
  final bool isMobile;

  /// Creates a [VitPopover] with configurable layout, content, and behavior options.
  ///
  ...
  ///
  /// For most use cases, prefer using [VitPopover.show] to display the popover
  ...
  ///
  /// Unlike [VitSheet.show], this presentation style maintains consistent

...
///
/// The [VitChip] represents a selectable or informational element that can be
/// used standalone or as part of a [VitChipGroup] for multi-selection scenarios.
///
/// ## Usage
///
/// ### Standalone Chip
...
enum VitChipPosition {
  left,
  right,
}

class VitChip extends StatefulWidget {
  ...
  ///
  /// Used when the chip is part of a [VitChipGroup] to identify which chip was selected.
  final dynamic value;
  ...
  @override
  State<VitChip> createState() => _VitChipState();
}

class _VitChipState extends State<VitChip> {
  ...
  @override
  void didUpdateWidget(VitChip oldWidget) {

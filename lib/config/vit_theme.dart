import 'package:vit_design_system/config/vit_configuration.dart';
import 'package:vit_design_system/config/vit_values.dart';
import 'package:flutter/material.dart';
import 'vit_strings.dart';

/// A class that contains the theme used by Vit components.
...
class VitTheme {
  ...
  /// The strings used by Vit components. Used to translate the app.
  ...
  VitTheme({
    ...
    this.titleBig = VitTheme.titleBigStyle,
    this.title = VitTheme.titleStyle,
    this.titleSmall = VitTheme.titleSmallStyle,
    this.bodyBig = VitTheme.bodyBigStyle,
    this.body = VitTheme.bodyStyle,
    this.bodySmall = VitTheme.bodySmallStyle,
    this.labelBig = VitTheme.labelBigStyle,
    this.label = VitTheme.labelStyle,
    this.labelSmall = VitTheme.labelSmallStyle,
    this.bitStrings = const VitStrings(),
    this.borderRadius = const BorderRadius.all(Radius.circular(8)),
    this.visualDensity = VisualDensity.standard,
    this.buttonMaxWidth = 450,
    this.values = const VitValues(),
    this.configuration = const VitConfiguration(),
  });
}

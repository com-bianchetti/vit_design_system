...
void main() {
  ...
  testWidgets('renders only child when controller isVisible is false', (
    ...
    final controller = BitBadgeController(count: 5, isVisible: false);
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
  ...
  testWidgets('updates when controller count changes', (
    ...
    final controller = BitBadgeController(count: 3);
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
          controller: controller,
  ...
  testWidgets('updates when controller label changes', (
    ...
    final controller = BitBadgeController(label: 'Old');
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
          controller: controller,
  ...
  testWidgets('updates when controller icon changes', (
    ...
    final controller = BitBadgeController(icon: Icons.star);
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
          controller: controller,
  ...
  testWidgets('updates when controller visibility toggles', (
    ...
    final controller = BitBadgeController(count: 5, isVisible: true);
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
          controller: controller,
  ...
  testWidgets('uses controller values over widget values', (
    ...
    final controller = BitBadgeController(count: 10);
    await tester.pumpWidget(
      wrapWithMaterial(
        BitBadge(
          controller: controller,
  ...
  testWidgets('disposes internal controller when not provided', (
    ...
    expect(find.byType(BitBadge), findsNothing);
  });

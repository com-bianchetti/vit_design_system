...
void main() {
  group('VitButton', () {
    ...
    testWidgets('uses theme disabled color when disabled and no custom color', (
      ...
      final theme = VitTheme(disabledColor: Colors.blueGrey);
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: VitAppTheme(
    ...
    testWidgets('uses theme visual density when not provided', (tester) async {
      final theme = VitTheme(visualDensity: VisualDensity.comfortable);
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: VitAppTheme(
    ...
    testWidgets('applies semantic label for accessibility', (tester) async {
      ...
      expect(
        tester.getSemantics(find.byType(VitButton)),
        matchesSemantics(
          label: 'Custom Label',
          isButton: true,
        ),
    ...
    testWidgets('uses theme max width when not provided', (tester) async {
      final theme = VitTheme(buttonMaxWidth: 500);
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: VitAppTheme(
    ...
    testWidgets('applies min width property', (tester) async {
      ...
      final button = tester.widget<VitButton>(find.byType(VitButton));

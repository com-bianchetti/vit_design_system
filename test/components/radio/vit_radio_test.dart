...
import 'package:vit_design_system/components/radio/vit_radio.dart';
...
void main() {
  ...
  group('VitRadioGroup', () {
    testWidgets('renders all radio options', (tester) async {
      ...
      expect(find.byType(VitRadio<String>), findsNWidgets(3));
      expect(find.text('Option 1'), findsOneWidget);

...
void main() {
  ...
  testWidgets('hides when isVisible is false', (WidgetTester tester) async {
    await tester.pumpWidget(
      wrapWithMaterial(
        const VitProgress(isVisible: false),
      ),
    );
  ...
  testWidgets('updates when controller value changes', (
    ...
    final controller = VitProgressController(value: 0.3);
    await tester.pumpWidget(
      wrapWithMaterial(
  ...
  testWidgets('updates when controller indeterminate changes', (
    ...
    final controller = VitProgressController(value: 0.5);
    await tester.pumpWidget(
      wrapWithMaterial(
        VitProgress(controller: controller),
      ),
  ...
  testWidgets('updates when controller visibility changes', (
    ...
    final controller = VitProgressController(value: 0.5, isVisible: true);
    await tester.pumpWidget(
      wrapWithMaterial(
        VitProgress(controller: controller),
      ),
  ...
  testWidgets('resets progress', (WidgetTester tester) async {
    final controller = VitProgressController(value: 0.7);
    await tester.pumpWidget(
      wrapWithMaterial(
        VitProgress(controller: controller),
      ),
  ...
  testWidgets('uses controller values over widget values', (
    ...
    final controller = VitProgressController(value: 0.8);
    await tester.pumpWidget(
      wrapWithMaterial(
        VitProgress(
  ...
  testWidgets('disposes internal controller when not provided', (
    ...
    expect(find.byType(VitProgress), findsNothing);
  });
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: VitApp(
          ...
          home: Scaffold(
            body: Center(
              child: const VitProgress(value: 0.5),
            ),
          ),
        ),
      ),

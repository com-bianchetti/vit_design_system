...
final VitLoadingStory = Story(
  name: 'VitLoading',
  description: 'VitLoading component to display a loading overlay.',
        ...
        child: Column(
          ...
          children: [
            ...
            VitButton(
              ...
              onPressed: () async {
                final userData = await VitLoading.show<Map<String, String>>(
                  context: context,
                  future: Future.delayed(

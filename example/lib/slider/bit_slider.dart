...
final BitSliderStory = Story(
  name: 'BitSlider',
  description: 'BitSlider component to display a slider control',
  wrapperBuilder: (context, child) => BitApp(
    debugShowCheckedModeBanner: false,
    theme: BitTheme(),
    home: child,
  ),
  builder: (context) => _BitSliderStoryWidget(),
);

class _BitSliderStoryWidget extends StatefulWidget {
  @override
  State<_BitSliderStoryWidget> createState() => _BitSliderStoryWidgetState();
}

class _BitSliderStoryWidgetState extends State<_BitSliderStoryWidget> {

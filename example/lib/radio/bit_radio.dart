...
final BitRadioStory = Story(
  name: 'BitRadio',
  description: 'BitRadio component to display radio buttons',
  wrapperBuilder: (context, child) => BitApp(
    debugShowCheckedModeBanner: false,
    theme: BitTheme(),
    home: child,
  ),
  builder: (context) => _BitRadioStoryWidget(),
);

class _BitRadioStoryWidget extends StatefulWidget {
  @override
  State<_BitRadioStoryWidget> createState() => _BitRadioStoryWidgetState();
}

class _BitRadioStoryWidgetState extends State<_BitRadioStoryWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              BitRadio<String>(
                ...
                title: 'Male',
                radioPosition: BitRadioPosition.right,
              ),
              const SizedBox(height: 8),
              BitRadio<String>(
                value: 'option2',
